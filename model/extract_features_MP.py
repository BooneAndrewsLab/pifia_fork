...
def create_dataset_for_protein(protein, gene_map, seek_ch):
    ...
    dataset_val = dataset_utils_MP.get_dataset_from_lists(filenames_channels_list_val, fnames_mask_val, labels_val,
                                                          seek_ch, num_classes=num_classes,
...
def get_features_from_protein(protein, gene_map, model, seek_ch, average=True):
    dataset_protein = create_dataset_for_protein(protein, gene_map, seek_ch)
